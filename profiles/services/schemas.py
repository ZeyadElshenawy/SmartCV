...
class ResumeSchema(BaseModel):
    ...
    volunteer_experience: List[ItemDetailed] = Field(default_factory=list)
    awards: List[ItemDetailed] = Field(default_factory=list)
    publications: List[ItemDetailed] = Field(default_factory=list)
    speaking_engagements: List[ItemDetailed] = Field(default_factory=list)
    patents: List[ItemDetailed] = Field(default_factory=list)
    military_experience: List[ItemDetailed] = Field(default_factory=list)
    hobbies: List[str] = Field(default_factory=list)
    references: List[ItemDetailed] = Field(default_factory=list)
    courses: List[ItemDetailed] = Field(default_factory=list)
